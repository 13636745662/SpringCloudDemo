...
public class AudioTransController {
    ...
    // 阿里云鉴权client
    IAcsClient client;
    public AudioTransController(String accessKeyId, String accessKeySecret) {
        // 设置endpoint
        try {
    ...
    public static void main(String args[]) throws Exception {
        ...
        final String accessKeyId = "LTAI4Ff23rKxgKrnCXK4kHVN";
        final String accessKeySecret = "vgxhYOwJALUGFH6PM4SoBFG38nwkC6";
        final String appKey = "4QzT720COwByYRy6";
        String fileLink = "https://fs.haoma.cn/record/1089/2020/2020-03/2020-03-05/batch_call_13152338915_10891310_7828a931-f105-47cc-bf3f-d7166ab93545g105t464EXT.mp3";
        AudioTransController demo = new AudioTransController(accessKeyId, accessKeySecret);
